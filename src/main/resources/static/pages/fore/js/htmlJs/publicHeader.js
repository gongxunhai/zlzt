...
document.writeln("                <li  id=\'userNav\'><i class=\'iconfont icon-guanjiaowangtubiao01\'></i><a href=\'"+domain+"/pages/fore/users/login.html\'>登录</a><span>|</span><a href=\'"+domain+"/pages/fore/users/register.html\'>注册</a></li>");
document.writeln("            </ul>");
...
document.writeln("                <span><img src=\'"+domain+"/pages/fore/images/logoNew.png\' class=\'img-responsive\'></span>");
document.writeln("            </a>");
document.writeln("        </div>            ");
...
document.writeln("                <li id=\'index\'><a href=\'"+domain+"/pages/fore/gfArea/zlResult.html\'><span>首页</span></a></li>");
...
document.writeln("                        <li><a href=\'http://www.innojoy.com/account/login2.html?idEMail=haiyingadmin@163.com&idPassword=123456&url=special/progress.htm?ProjectID=2605\'>专利专题</a></li>");
...
document.writeln("                        <li><a href=\'"+domain+"/pages/fore/kjService/kjService.html\'>产品服务</a></li>");
document.writeln("                    </ul>");
document.writeln("                  </li>");
