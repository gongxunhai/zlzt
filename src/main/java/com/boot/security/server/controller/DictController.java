...
public class DictController {
    ...
    @PostMapping("/getKByValAndType")
    @ApiOperation(value = "通过值和类型获取key")
    public Dict getKByValAndType(@RequestParam(value = "type") String type,@RequestParam( value = "val") String val){
        return dictDao.getKByValAndType(type,val);
    }
}
